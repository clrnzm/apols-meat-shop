...
export function Hero() {
  return (
    ...
    >
      <div className="flex flex-1 items-center pb-12 pt-32 sm:pb-16 sm:pt-36 lg:py-40">
        <Container>
          <div className="max-w-4xl">
            <p className="flex items-center gap-3 text-xs font-bold uppercase tracking-[0.2em] text-warm-red sm:text-sm">
            ...
            <h1
              id="hero-heading"
              className="mt-6 max-w-4xl font-display text-5xl font-bold leading-[0.98] tracking-[-0.045em] text-light-text sm:text-6xl lg:text-7xl xl:text-[5.25rem]"
            >
